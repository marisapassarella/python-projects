...
mygame = tk.Tk()
mygame.resizable(False, False)
mygame.title("Tic Tac Toe")

tk.Label(mygame, text = 'Tic Tac Toe', font =('Comic Sans MS', 25)).pack()
status_label = tk.Label(mygame, text = "X's turn", font=('Comic Sans MS', 15), bg ='coral', fg = 'white')
...
play_again_button = tk.Button(mygame, text = 'Play again', font=('Comic Sans MS', 15), command = play_again)


current_chr = 'X'

play_area = tk.Frame(mygame, width = 300, height = 300, bg = 'white')
...
class XOPoint:
    ...
    def set(self):
        global current_chr
        if not self.value:
            self.button.configure(text = current_chr, bg = 'snow', fg = 'darkred')
